                                        	...
                                        	<div class="form-group">
                                                ...
                                                <div class="row"><br />
                                                	<div class="col-md-6 col-sm-6 col-xs-12">
        												...
        												<input type="radio" checked="checked" name="MisReport" value="WarehouseDetails">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    	<div class="col-md-11 col-sm-11 col-xs-11" style="width:auto;">
        												<label>Consignment Report &nbsp; &nbsp;</label>
                                                        </div>
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
                                                ...
                                                <div class="row"><br /><br />
                                                	<div class="col-md-5 col-sm-5 col-xs-12 col-sm-offset-5">
                                                    	<input type="submit" name="Print" value="Print Preview" class="btn btn-success" />
                                                    </div>        											
    											</div>                                     	
    										</div>
                                    	</div>
