...
if(isset($_SESSION['timeout']))
{
	...
	else
	{
		...
		else
		{
			...
			$Ref=$_SESSION['Ref'];
			$errQuantity="";
			$qrydamge="SELECT COALESCE(SUM(Quatity),0)AS qty FROM warehousedamagestock WHERE WareHouseId='$RefId' AND DamageStatus='Y'";
			...
			if(isset($_POST['ok']))
			{
				...
				{
					$errQuantity="Only Number Allowed";
				}
				else
				{
		         ...
		         $qrydamge="SELECT COALESCE(SUM(Quatity),0)AS qty FROM  warehousedamagestock WHERE WareHouseId='$RefId' AND DamageStatus='Y'";
				   $checkdamage=mysqli_query($con,$qrydamge);
					...
					else
					{
						...
						$q="INSERT INTO tblwarehousereplacement(Quatity,DamageDate,Reason,RecStatus,WareHouseId,DamageStatus)VALUES('$Quantity','$DamageDate','$reason','A','$RefId','N')";
						...
						if($run)
						{
							...
							$mail->Subject    = "Regarding Replacement Quantity ";
							$mail->Body = "<h3>Dear Opreation  Team</h3>
											</br><h4>Please Verify the following Replacemnt</h4>
											</br>Quantity:$Quantity<p></p>
											</br>Date:$DamageDate<p></p>
											</br><p></p>											
											</br><p></p>
											<br><br><br>
							...
							if(!$mail->Send())
							{
								...
								echo "<script>window.open('Replacement.php','_self')</script>";
							}
							else 
							{
								echo "<script>alert('Replacement stock records  saved successFully!')</script>";
 ...
 <div class="container body">
        <div class="main_container">
			...
			<div class="x_panel">
                  ...
                  <div class="x_content"><form class="form-horizontal form-label-left" method="post" action="Replacement.php" onsubmit="return checkDate();">
  
 <div class="item form-group">
  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Replacement Quantity<span class="required" style="color:red">*</span></label>
<div class="col-md-5 col-sm-5 col-xs-12">

<input class="form-control col-md-7 col-xs-12 number" name="LEDQuentity" onpaste="return false" required="required" type="text" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Enter Replacement Quantity" id="enterqty">
<span style="color:#F00;"><?php echo $errQuantity;?></span>
</div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >Replacement Date<span class="required" style="color:red">*</span>
                                            </label>
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <input type="date" id="Pay_date1" onpaste="return false" name="date" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="item form-group">
...
<div class="col-md-5 col-sm-5 col-xs-12"><input id="textValidate" name="Reason" onpaste="return false" class="form-control" maxlength="100" placeholder="Enter any Reason" required="required" type="text"></div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-5">
                                                ...
                                                <button id="send" name="ok" type="submit" onclick="return checkqty();" class="btn btn-primary">Save Record</button>
