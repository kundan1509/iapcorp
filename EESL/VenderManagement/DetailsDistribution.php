	...
	else
	{
		...
		else
		{
			if(isset($_GET['SalesId']))
			{
	            ...
	            VD.Quantity,
				DATE_FORMAT(VD.SaleDate,'%d-%m-%y') AS SaleDate,										
				VD.SalesId,
				VN.VendorName,                                            
				VN.VendorCode
				FROM tbllocation AS L JOIN tblvendorlocation AS VL JOIN vendorsales AS VD JOIN tblvendorregistration AS VN      
                WHERE L.LocId=VL.LocationId AND VL.locationid=VD.LocationId AND VD.VendorId=VN.VendorId  AND   VD.RecStatus='A'  and VD.SalesId=$SalesId";		
...
<title>Details   Distribution</title>
            ...
            <div class="right_col" role="main">            
				<div class="row">                
                        <div class="col-md-12 col-sm-12 col-xs-12">                        
                        	...
                        	<input type="hidden" value="<?php echo $SalesId; ?>" name="SalesId" />
                        ...
                        <div class="item form-group">
                            ...
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Distribution Date<span class="required"></span></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                	<input id="name" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="name" required="required" type="text" value="<?php echo $saledate; ?>" readonly="readonly">
                                </div>
                            </div>                         							
                              <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            ...
                            <div class="ln_solid"></div>
                            	<div class="form-group">
                                	<div class="col-md-6 col-md-offset-3 col-xs-12">                              
                                        <a  href="SalesDisplay.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                                	</div>
                            </div>
                        </form>
