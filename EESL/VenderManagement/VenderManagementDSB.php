...
if(isset($_SESSION['timeout']))
{
	...
	else
	{
		...
		$walletbal="select Balance from tblwallet where VendorId='$RefId'";
		$fetchwalletbal=mysqli_query($con,$walletbal);
		$row=mysqli_fetch_array($fetchwalletbal);
		$balnce=$row['Balance'];
...
<title>Distributor Management DashBorad</title>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
							  <div class="x_title" style="color:#FFF; background-color:#889DC6;">                           
                                <h2>&nbsp; Welcome To The Distributor Management System </h2>                            
                         ...
                         <div class="item form-group">
                            	<div class="col-lg-4 col-sm-4 col-xs-12">
                            		<label >Your wallet balance is <span class="required"></span></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                <label ><span class="required"></span>Rs.<?php echo $balnce; ?></label>
