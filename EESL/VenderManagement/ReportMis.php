                                        	...
                                        	<div class="form-group">
                                        		<div class="row">
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
        												...
        												<input type="radio" checked="checked"  name="report" value="stock_report" class="input-md radioReport">
                                                        </div>
                                                    </div> 
                                                	<div class="col-md-6 col-sm-6 col-xs-12">
                                                    	<div class="col-md-11 col-sm-11 col-xs-11" style="width:auto;">
        												<label> Distributor Payment Details </label>
                                                        </div>
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
        												<input type="radio" name="report" value="payment_report" class="input-md radioReport">
                                                        </div>
                                                    </div>
                                                         											
    											</div> 
                                                <div class="row"><br /><br />
                                                	<div class="col-md-5 col-sm-5 col-xs-12 col-sm-offset-4">
                                                    	<button  name="printpreview" id="btnReport" type="submit" class="btn btn-md btn-success" style=" width:120px;" onclick="return confirm('Are you  sure to print report  ?');" >Print Preview</button> 
                                                    </div>        											
    											</div>                                     	
    										</div>
                                    	</div>
