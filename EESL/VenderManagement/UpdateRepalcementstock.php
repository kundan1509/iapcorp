			...
			{  
				...
				else
				{
					...
					{	 	
						...
						$update = " update tblvendorreplacement set
						Quatity='$quantity',
						DamageDate='$damagedate',
						Reason='$reason',
						LocationId='$location'
						where replacementId='$DamageId' and RecStatus='A' and DamageStatus='N'";	 
		
						if(mysqli_query ($con,$update))
						{
							echo "<script>alert('Replacement stock updated successfully !')</script>";	
							echo "<script>window.open('REplacementDisplay.php','_self')</script>";
						}		
						else
						{
							echo "<script>alert('Replacement stock  not updated !')</script>";             
						}
...
<title>Update Replacement Stock</title>
...
function checkDamageStockOnUpdate(id,event) {
	event.preventDefault();

//return false;
	/*setTimeout(function(){
	 	//return confirm('Are you  sure to update replacement stock  ?'); 
		if(confirm('Are you  sure to update replacement stock  ?')){
			alert('now all is ok');
		}
	}, 1000);*/
...
if(depdate>today)
{
	alert('Replacement date not greater than current date');
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">                        
                            <div class="x_panel">                      
                               <div class="x_title" style="color:#FFF; background-color:#889DC6;">                           
                                <h2>&nbsp; Update Replacement Stock</h2>                      
                               ...
                               <form class="form-horizontal" id="update_rep_form" method="post" action="UpdateRepalcementstock.php" enctype="multipart/form-data" onsubmit="return checkDate();"  >
                             
<input type="hidden" value="" name="update_Damage" />
                            ...
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Replacement  Date<span style="color:red; margin-top:8px;"> *</span></label>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-12">
							  ...
							  <div class="col-md-3 col-sm-3 col-xs-12">
                             <input class="form-control col-md-7 col-xs-12" placeholder=" Select  Replacement Date" id="name" name="Right_off1"  AUTOCOMPLETE ="off" onpaste="return false;" type="date"/> 
                                </div>
                            </div>
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                              ...
                              <div class="item form-group">
                               ...
                               <div class="col-md-3 col-sm-3 col-xs-12">
									  ...
									  <select id="location" name="location" onpaste="return false;" AUTOCOMPLETE="off" class="form-control col-md-7 col-xs-12" required="Required" value="<?php echo $LName; ?>">
                            ...
                            <div class="ln_solid"></div>
                            	<div class="form-group">
                                   ...
                                   <button  name="update_Damage" id="btnCheck"  type="submit" class="btn btn-md btn-info" style=" width:120px;"  onclick="checkDamageStockOnUpdate('quantity',event);" >Update Records</button>									
