				...
				<div class="row">                
                        <div class="col-md-12 col-sm-12 col-xs-12">                        
					       ...
					       <div class="item form-group">
                            ...
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Amount <span class="required"></span></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                	<input id="name" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="name" required="required" type="text" value="<?php echo $Amount; ?>"readonly="readonly">
                                </div>
                            </div>
							 <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Bank Name <span class="required"></span></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                	<input id="name" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="name" required="required" type="text" value="<?php echo $BankNmae; ?>"readonly="readonly">
                                </div>
                            </div>
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Payment Mode <span class="required"></span></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                	<input id="name" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="name" required="required" type="text" value="<?php echo $PayMode; ?>" readonly="readonly">
                                </div>
                            </div>
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Taxn. No. <span class="required"></span></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                	<input id="name" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="name" required="required" type="text" value="<?php echo $TxnNo; ?>" readonly="readonly">
                                </div>
                            </div>
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Payment Date <span class="required"></span></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                	<input id="name" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="name" required="required" type="text" value="<?php echo $PatDate; ?>" readonly="readonly">
                                </div>
                            </div>
							<div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Payment Proof</label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">                                
									 <a class="example-image-link" href="<?php echo $PayProf; ?>" data-lightbox="example-1">
									  <img  class="example-image img-responsive" data-lightbox="example-1" src="<?php echo $PayProf; ?>" style="max-height:150px; min-height:150px; max-width:200px; min-width:100px;" /></a>
                                </div>
                            </div>                            
