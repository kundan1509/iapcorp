	...
	else
	{
		...
		{ 
			if (isset($_POST['Save_Damage']))
			{
				...
				$warehouseid=$_POST['warehousedetail'];
				$updatedId=$Refid;
				$VenderId =$Refid;
				$Restaus = 'A';
				$DamageStatus='N';	
				...
				else
				{
					...
					WHERE RecStatus='A' AND VendorId='$Refid' AND LocationId='$location_name'";	
					...
					if($query)
					{
						...
						if($tot>=$quantity)
						{
							...
							$insert_damagestock = "INSERT INTO vendordamagestock(Vendorid,Quatity,DamageDate,Reason,RecStatus,LastUpdateOn,UpdatebyID,LocationId,DamageStatus,warehouseid)
							VALUES('$VenderId','$quantity','$date','$Region_type','$Restaus','$CurrentDate','$updatedId','$location_name','$DamageStatus','$warehouseid')";		  
							if(mysqli_query ($con,$insert_damagestock))
							{							
								echo "<script>alert('Damage stock records  saved successfully !')</script>";	
								echo "<script>window.open('VendorDamage.php','_self')</script>";
							}
				...
				<div class="row">                
                        <div class="col-md-12 col-sm-12 col-xs-12">                        
                            <div class="x_panel">                            
                               ...
                               <br />
                               <form action="VendorDamage.php" method="post" enctype="multipart/form-data" onsubmit="return checkDate();">
                       				<div class="row">                                    
                          				<div class="col-md-12 col-sm-12 col-xs-12">                                        
                            				<div class="x_panel">                                                                           
                                				<div class="x_content">                                                           
                              								...
                              								<div class="col-sm-6 col-xs-8">
                                 								<div class="col-sm-5 col-xs-8">
                           										...
                           										<div class="col-sm-7 col-xs-12">
                                                                                                            <input  class="form-control input-md"   name="Qunatity_name" maxlength="10" AUTOCOMPLETE ="off"   placeholder=" Please Enter Quantity "  type="text" required="Required" id="quantity" onpaste="return false;">
                           ...
                           <div class="col-sm-7 col-xs-12">
                         <input id="textValidate" class="form-control input-md"  name="Region_type" maxlength="100"    placeholder=" Please Enter  Reason" AUTOCOMPLETE ="off" onDrag="return false" onDrop="return false"    type="text" required="Required" onpaste="return false;">
                                </div>   
                             </div>
                              </div>
                          <div class="row"><br />
                              <div class="col-sm-6 col-xs-8">
                                 <div class="col-sm-5 col-xs-8">
                                 <h4><label for="exampleInputPassword1"  style="font-size:14px;" >Damage Stock Date<span style="color:red; margin-top:8px;"> *</span></label></h4>                 
                              </div>
                           <div class="col-sm-7 col-xs-12">
                         <input  id="Billing_date" class="form-control input-md"  name="Rightoff_date"  placeholder=" Please Enter  Damage Date"  type="date" required="Required">
                                </div>   
                             </div>
                              </div>
                           ...
                           <div class="col-sm-7 col-xs-12">
                          <select id="whid" name="warehousedetail" class="form-control col-md-7 col-xs-12" required="Required">                                      
                                      <?php
                              ...
                              <br />
                                      	<div class="row"><br />           
                                			<div class="col-sm-5 col-xs-12  col-md-offset-3 col-xs-offset-3">
                                       			<button  name="Save_Damage" id="btnCheck" type="submit" class="btn btn-md btn-info" style=" width:130px;"  >Save Records</button>
