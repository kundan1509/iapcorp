	...
	else
	{
		...
		else
		{
			if(isset($_GET['IssueSlipId']))
			{
				...
				$ViewIssueslip= "SELECT vi.IssueSlipId,vi.TotalAmount,vi.Quantity,vi.IssueCode,vi.VendorID,vi.IssueDate,vi.Rate,vi.WareHouseId,vi.IssueCode,w.warehousecode,w.WareHouseName,loca.Locationname,
				v.VendorId,v.VendorCode,v.VendorName,v.ContactNumber,v.EmailId,v.VendorStatus
				FROM tblissueslip AS  vi JOIN tblvendorregistration AS v ON vi.VendorID=v.VendorId JOIN tblwarehouseregistration AS w ON vi.warehouseid=w.warehouseid
				JOIN tblvendorlocation AS l ON vi.locationid=l.locationid JOIN tbllocation AS loca ON l.locationid=loca.Locid
				WHERE vi.IssueSlipId='$IssueId' AND vi.RecStatus = 'A' AND vi.IssueStatus = 'P'";
...
<link href="../Designing/css/bootstrap.min.css" rel="stylesheet">
    ...
    <script src="../Designing/js/jquery.min.js"></script>
        ...
        function PrintDivContent(divId) {
			...
			var WinPrint = window.open('', 'Print  Report', 'height=400,width=600');
            ...
            <div class="right_col" role="main">            
				<div class="row">                
                   ...
                   <div class="x_content"  id="printme" >               
                     <form   class="form-horizontal"  method="post" onsubmit="return checkLength(this);" action="ReportIssueslip.php" enctype="multipart/form-data" novalidate>
                        	<input type="hidden" value="<?php echo $IssueSlipId; ?>" name="IssueSlipId" />
                            <input type="hidden" value="<?php echo  $VID; ?>" name="VeId" />
					       ...
					       <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                	<input id="textValidate" class="form-control col-sm-5 col-xs-12" placeholder=" Representative name"  name="Ven_repereNmae"  maxlength="50" AUTOCOMPLETE ="off"   required="Required" type="text" onpaste="returun false;"/>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                	<input  onblur="checkLength(this)" class="form-control col-sm-5 col-xs-12"  maxlength="10"  name="contact_no" AUTOCOMPLETE ="off" placeholder="Contact no"  required="Required" type="text" id="quantity" onpaste="returun false;"/>
                            ...
                            <div class="ln_solid"></div>
                            	<div class="form-group">
                                    ...
                                    <button  name="update_issueslip"  id="btnCheck" type="submit" class="btn btn-md btn-info" style=" width:120px;" >Update Records</button>                                 								
