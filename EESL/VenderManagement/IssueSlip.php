...
<body class="nav-md">
    ...
    <div class="container body">
       ...
       <table class="table table-striped table-bordered">
        <thead>
            <tr>
                <th style="width:200px;">Issue Code </th>
                <th style="width:200px;"> Issue Date</th>
                <th style="width:200px;">Quantity</th>
                <th style="width:200px;">Fund utilized from wallet</th>
                <th style="width:400px;">WareHouse Code</th>             
                   <th style="width:400px;">WareHouse Name</th>  
                    <th style="width:400px;">WareHouse Location</th>                               			
 ...
 <?php
   ...
   $per_page=10;
 	              ...
 	              $getissueslip="SELECT p.IssueSlipId, p.IssueCode,DATE_FORMAT(p.IssueDate,'%d-%m-%y') AS IssueDate,p.Quantity,p.TotalAmount,w.warehousecode,l.locationname,w.WareHouseName
FROM tblissueslip AS p JOIN tblwarehouseregistration AS w ON p.WareHouseId=w.WarehouseId JOIN tbllocation AS l ON w.warehouselocationid=l.locid WHERE w.RecStatus='A' AND p.RecStatus='A' AND p.IssueStatus='P'  AND p.VendorId='$Refid' ORDER BY p.IssueSlipId DESC LIMIT $start_from,$per_page";  
	  ...
	  $warehusename=$row['warehousecode'];
		 ...
		 echo "
            <tr>
                ...
                <td>
					  ...
					  <a href='UpdateIssueSlip.php?IssueSlipId=$IssueSlipId' class='btn btn-info'> Claim</a> 
...
<?php
        $query = ("SELECT p.IssueSlipId, p.IssueCode,DATE_FORMAT(p.IssueDate,'%d-%m-%y') AS  IssueDate,p.Quantity,p.TotalAmount,w.warehousecode,l.locationname	
					...
					WHERE w.RecStatus='A' AND p.RecStatus='A' AND p.IssueStatus='P'  AND p.VendorId='$Refid' ORDER BY p.IssueSlipId  DESC");
