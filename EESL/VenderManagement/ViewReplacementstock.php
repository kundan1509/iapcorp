...
if(isset($_SESSION['timeout']))
{
	...
	else
	{
		...
		{
			if(isset($_GET['replacementId']))
			{
				$DamId=$_GET['replacementId'];		
				$result= "SELECT L.LocationName,w.WareHouseName,w.WareHouseCode,
						...
						VN.VendorName,
						VN.VendorCode
						FROM tbllocation AS L JOIN tblvendorlocation AS VL JOIN tblvendorreplacement AS VD JOIN tblvendorregistration AS VN join tblwarehouseregistration as w   
                       WHERE L.LocId=VL.LocationId AND VL.locationid=VD.LocationId AND VD.Vendorid=VN.VendorId  and VD.RecStatus='A' and VD.DamageStatus='N' and VD.replacementId='$DamId' and w.warehouseid=VD.warehouseid";
...
<title>Details  Replacement Stock</title>
				...
				<div class="row">                
                        <div class="col-md-12 col-sm-12 col-xs-12">                        
                            <div class="x_panel">                         
                                ...
                                <h2>Replacement Stock Details</h2>                               
                        	...
                        	<input type="hidden" value="<?php echo $$DamageId; ?>" name="replacementId" />
                        ...
                        <div class="item form-group">
                            ...
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Replacement  Date<span class="required"></span></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                	<input id="name" class="form-control col-md-7 col-xs-12"  name="name" required="required" type="text" value="<?php echo $damagedate; ?>" readonly="readonly">
                                </div>
                            </div>
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Reason  <span class="required"></span></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                	<input id="name" class="form-control col-md-7 col-xs-12"  name="name" required="required" type="text" value="<?php echo $Reson; ?>" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="ln_solid"></div>
                            	<div class="form-group">
                                	<div class="col-md-6 col-md-offset-3 col-xs-12">                              
                                        <a  href="REplacementDisplay.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                                	</div>
                            </div>
                        </form>
