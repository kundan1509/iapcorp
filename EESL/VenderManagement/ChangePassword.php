	...
	else
	{
		...
		else
		{
			if(isset($_POST['ResetPassword']))
			{
				...
				$fetchData="select password from tbluser where Id='$UserId' AND RecStatus='A'";
...
<link href="../Designing/css/bootstrap.min.css" rel="stylesheet">
   ...
   <script type="text/javascript">
		...
		function fd3() {
    var v1 = document.getElementById("repass2").value;
	if(v1!="")
	{
    ...
    {
        document.getElementById("repass2").focus();
    }, 0);
		return false;
 ...
 <script type="text/javascript">
        $(function () {
            $('#btnCheck').click(function () {
				...
				var txtpass=$('#newpassword');
			    var txtoldpass = $('#repass2');								
			    if (txtnewpass.val() != '' && txtpass.val() != '' && txtoldpass.val()!= '' && txtoldpass.val() != '') {             
                   return true;
                }
                else{
                     ...
                     <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                    <li><a href="javascript:;"> <i class="fa fa-sign-out pull-right"></i>Change Password</a>
                                    </li>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 col-sm-4 col-xs-12">Enter Old Password<span style="color:red; margin-top:8px;"> *</span></label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                            	<input type="password" id="newpass" name="Password" required="required" class="form-control input-sm" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 col-sm-4 col-xs-12">Enter New Password<span style="color:red; margin-top:8px;"> *</span></label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                               <input type="password" name="RePassword" id="newpassword" onblur="fd4();"  required="required" class="form-control input-sm" />
                                               <span style=" color:#60C">password should be 8-15 character</span>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-md-4 col-sm-4 col-xs-12">Re-Enter New Password<span style="color:red; margin-top:8px;"> *</span></label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                               <input type="password" name="RePassword1" id="repass2" onblur="fd3();" required="required" class="form-control input-sm" />
                                               <span style=" color:#60C">password should be 8-15 character</span>
                                            </div>
                                        </div>
                                   ...
                                   <button type="submit" id="btnCheck" name="ResetPassword" class="btn btn-md btn-info" style=" width:120px;" onclick="return confirm('Are you  Sure to change password ?');">Save Changes</button>
