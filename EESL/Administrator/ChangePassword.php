                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-5 col-sm-5 col-xs-12">Enter Old Password</label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                            	<input type="password" name="Password" class="form-control input-sm" id="txtpass" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-5 col-sm-5 col-xs-12">Enter New Password</label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                               <input type="password" id="newpass" name="RePassword" onblur="return fd4();" class="form-control input-sm" maxlength="15"/>
                                               <span style=" color:#60C">password should be 8-15 character</span>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-md-5 col-sm-5 col-xs-12">Re-Enter New Password</label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                               <input type="password" id="newpassword" name="RePassword1" onblur="return fd3();"  class="form-control input-sm"  maxlength="15"/>
                                               <span style=" color:#60C">password should be 8-15 character</span>
                                            </div>
                                        </div>
