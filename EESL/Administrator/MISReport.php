                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" style="color:#FFF; background-color:#889DC6;">
                                    <h2>Welcome to The Administrator</h2>
                                ...
                                <div class="x_panel">                            
                                <div class="x_content">
                                	<form method="post" action='../adminReport/resultreport.php'>                                    	
                                        <div class="x_content">                                    
                                        	...
                                        	<div class="form-group">
                                        		<div class="row">
                                                	<div class="col-md-6 col-sm-6 col-xs-12">
        												...
        												<input type="radio" name="MisReport" value="PaymentDetails">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    	<div class="col-md-11 col-sm-11 col-xs-11" style="width:auto;">
                                                        ...
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
        												<input type="radio" name="MisReport" value="StockDetails">
                                                        </div>
                                                    </div>        											
    											</div> 
                                                <div class="row"><br /><br />
                                                	<div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
        												<input type="radio" name="MisReport" value="WarehouseDetails">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    	<div class="col-md-11 col-sm-11 col-xs-11" style="width:auto;">
                                                        ...
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
        												<input type="radio" name="MisReport" value="EESLDetails">
                                                        </div>
                                                    </div>        											
    											</div>
                                                <div class="row"><br /><br />
                                                	<div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
        												<input type="radio" name="MisReport" value="distSecurity">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    	<div class="col-md-11 col-sm-11 col-xs-11" style="width:auto;">
                                                ...
                                                <div class="row"><br /><br />
                                                	<div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
        												<input type="radio" name="MisReport" value="EESLPaymentsDetails">
                                                        </div>
                                                    </div>
