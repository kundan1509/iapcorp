                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">                            
                            <ul class="nav side-menu">
                                ...
                                <li><a href="../Finance Management/FinanceManagementDSB.php"><i class="fa fa-home"></i> Finance </a></li>
                                <li><a href="../Opreation/OperationDSB.php"><i class="fa fa-home"></i> Operation </a></li>
