...
<div class="row">
        ...
        <thead>
            <tr>
                ...
                <th style="width:250px;">Warehouse Name</th>
                 <th style="width:250px;">Manager Name</th>
        ...
        <tbody>
         ...
         $result = "SELECT tblwarehouseregistration.warehouseid,tblwarehouseregistration.WareHouseName,tblwarehouseregistration.warehousecode,tbllocation.locationname,
tbldispatcherregistraion.dispatchername,tbldispatcherregistraion.contactnumber,tbldispatcherregistraion.mailingaddress
FROM tblwarehouseregistration INNER JOIN tbldispatcherregistraion ON tblwarehouseregistration.dispatcherid=tbldispatcherregistraion.dispatcherid
INNER JOIN tbllocation ON tblwarehouseregistration.warehouselocationid=tbllocation.locid ORDER BY tblwarehouseregistration.warehouseid DESC LIMIT $start_from,$per_page";
	  ...
	  $managername=$row['dispatchername'];
	  ...
	  /*$address=$row['mailingaddress'];*/
		 ...
		 echo "
            <tr>
                ...
                <td>
                    <a href='updatewarehouse.php?id=$whid' class='btn btn-success' title='Edit warehouse Records'><i class='fa fa-edit'></i></a>
          ...
          <!--  <a href='#' class='btn btn-danger' title='Edit Damage Records' onclick = 'return confirm('Are you sure want to delete record')'><i class='fa fa-trash'></i></a> -->
                
        </tbody>
    </table>
    
    <?php
            $query ="SELECT tblwarehouseregistration.warehousecode,tbllocation.locationname,
tbldispatcherregistraion.dispatchername,tbldispatcherregistraion.contactnumber,tbldispatcherregistraion.mailingaddress
FROM tblwarehouseregistration INNER JOIN tbldispatcherregistraion ON tblwarehouseregistration.dispatcherid=tbldispatcherregistraion.dispatcherid
INNER JOIN tbllocation ON tblwarehouseregistration.warehouselocationid=tbllocation.locid";
            $res = mysqli_query($con,$query);
            $total_records = mysqli_num_rows($res); 	
            $total_pages = ceil($total_records / $per_page);	
             echo "<center> <a href='warehouselist.php?page=1' class='btn btn-default fa fa-long-arrow-left'>".'First'."</a> ";
              for ($i=1; $i<=$total_pages; $i++)
	           {
               echo "  <a href='warehouselist.php?page=".$i."' class='btn btn-default'>".$i."</a> ";
               };
               echo "<a href=warehouselist.php?page=$total_pages' class='btn btn-default'>".'Last'." <i class='fa fa-long-arrow-right'></i></a></center> ";
?>
