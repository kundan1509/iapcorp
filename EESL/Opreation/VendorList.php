...
<div class="row">
        ...
        <thead>
            <tr>
                <th style="width:250px;">Distributor Code</th>
                <th style="width:250px;">Distributor Name</th>
               
                <th style="width:250px;">Contact Number</th>
                <th style="width:250px;">E-Mail Id</th>
                  <th style="width:250px;">Mailing Address</th>           			
        ...
        <tbody>
         ...
         $result = "SELECT tblvendorregistration.VendorCode,tblvendorregistration.VendorId,tblvendorregistration.VendorName,tblvendorregistration.ContactNumber,tblvendorregistration.EmailId,tblvendorregistration.Address1 FROM tblvendorregistration WHERE tblvendorregistration.RecStatus='A' ORDER BY tblvendorregistration.vendorid DESC LIMIT $start_from,$per_page";
	  ...
	  $address=$row['Address1'];
		 ...
		 echo "
            <tr>
                ...
                <td>
                    <a href='updatevendor.php?id=$venid' class='btn btn-success' title='Edit Distributor records'><i class='fa fa-edit'></i></a>
    ...
    <?php
            $query = ("SELECT tblvendorregistration.VendorCode,tblvendorregistration.VendorName,tblvendorregistration.ContactNumber,tblvendorregistration.EmailId,tblvendorregistration.Address1 FROM tblvendorregistration WHERE tblvendorregistration.RecStatus='A' ORDER BY tblvendorregistration.vendorid DESC");
            $res = mysqli_query($con,$query);
            $total_records = mysqli_num_rows($res); 	
            $total_pages = ceil($total_records / $per_page);	
             echo "<center> <a href='VendorList.php?page=1' class='btn btn-default fa fa-long-arrow-left'>".'First'."</a> ";
              for ($i=1; $i<=$total_pages; $i++)
	           {
               echo "  <a href='VendorList.php?page=".$i."' class='btn btn-default'>".$i."</a> ";
               };
               echo "<a href=VendorList.php?page=$total_pages class='btn btn-default'>".'Last'." <i class='fa fa-long-arrow-right'></i></a></center> ";
?>
                        </div>
