...
if(isset($_GET['id']))
	...
	$vendordamagedetail="SELECT tblconsignment.consignemtno,tblconsignment.Remark,tblconsignment.warehouseid,tbllocation.locationname,tblconsignment.ConsignmentProof,DATE_FORMAT(tblconsignment.consignmentdate,'%d-%m-%y')AS DATE ,tblconsignment.Quantity,tblwarehouseregistration.warehousename,tblwarehouseregistration.WareHouseCode,
tblconsignment.allotmentstatus,tblconsignment.indentquantity FROM tblconsignment INNER JOIN tblwarehouseregistration ON
tblconsignment.warehouseid=tblwarehouseregistration.warehouseid INNER JOIN tbllocation on tblwarehouseregistration.warehouselocationid=tbllocation.locid WHERE tblconsignment.recstatus='A' and tblconsignment.AllotmentStatus='P' and tblconsignment.CosigmentId='$cid'";
	  ...
	  $quantity=$row['Quantity'];
	   ...
	   $indentQuantity=$row['indentquantity'];
	   $Remark=$row['Remark'];
	   $proof=$row['ConsignmentProof'];
	   $whid=$row['warehouseid'];
	   $whaname=$row['warehousename'];
...
if(isset($_POST['Verify']))
{
	...
	if($Accept=='A')
	{
	$updatevendorDamage="UPDATE tblconsignment SET AllotmentStatus='D',Remark='$remark',lastupdateon='$currentDate',updatebyid='$RefId', RejectedReason='Approved' WHERE CosigmentId='$damid'";
	if(mysqli_query($con,$updatevendorDamage))
	{
		$insertinwareInventory="insert into tblwarehouseinventory(warehouseid,Quantity,TxnTypeIn_out,TransactionNo,RecStatus,PaymentDate,lastupdateon,updatebyid)values('$warehouseid','$quantity','IN','$csno','A','$csDate','$currentDate','$RefId')";
		mysqli_query($con,$insertinwareInventory);
		echo "<script>alert('Consignment successfully verified')</script>";
		echo "<script>window.open('Consignment.php','_self')</script>";
		
	}
	else
	{
		echo "<script>alert('Consignment Not Verified')</script>";
		echo "<script>window.open('Consignment.php','_self')</script>";
	}
	}
	else if($Accept=='R')
	{
		...
		if($Reasons=='Other')
		{
	$updatevendorDamage="UPDATE tblconsignment SET AllotmentStatus='R',Remark='$remark',lastupdateon='$currentDate',updatebyid='$RefId',RejectedReason='$ReasonsText' WHERE CosigmentId='$damid'";
	if(mysqli_query($con,$updatevendorDamage))
	{
		
		echo "<script>alert('Consignment Rejected')</script>";
		echo "<script>window.open('Consignment.php','_self')</script>";
		
	}
	else
	{
		echo "<script>alert('Consignment Not Verify')</script>";
		echo "<script>window.open('Consignment.php','_self')</script>";
	}
		}
		else
		{
			$updatevendorDamage="UPDATE tblconsignment SET AllotmentStatus='R',Remark='$remark',lastupdateon='$currentDate',updatebyid='$RefId',RejectedReason='$Reasons' WHERE CosigmentId='$damid'";
	if(mysqli_query($con,$updatevendorDamage))
	{
	...
	{
		echo "<script>alert('Cosignment Not Verify')</script>";
		echo "<script>window.open('Consignment.php','_self')</script>";
	}
		}
	}
...
if(isset($_POST['reject']))
{
	...
	$remark=$_POST['remark'];
	$warehouseid=$_POST['whid'];
	$updatevendorDamage="UPDATE tblconsignment SET AllotmentStatus='R',Remark='$remark',lastupdateon='$currentDate',updatebyid='$RefId' WHERE CosigmentId='$damid'";
	if(mysqli_query($con,$updatevendorDamage))
	{
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
			<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
				<title>Conginment Verification</title>
        			...
        			<div class="main_container">
            			<div class="col-md-3 left_col">
                			<div class="left_col scroll-view">
                    			<img src="images/logo.jpg"  style="width:220px; height:100px;"  alt="..." class="img-responsive">
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" style="color:#FFF; background-color:#889DC6;">
                                    <h2>Consignment Verification</h2>
                                    ...
                                    <div class="form-horizontal form-label-left">
                                     <div class="form-group">
                                    	...
                                    	<div class="form-group">
                                            ...
                                            <input type="hidden" value="<?php echo $whid;?>" name="whid" />
                                        	
                                            <label class="col-md-4 col-sm-4 col-xs-12">Warehouse Location:</label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <?php echo $warehousename;?>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-md-4 col-sm-4 col-xs-12">Consignment Date:</label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <?php echo $date; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 col-sm-4 col-xs-12">Indent Quantity:</label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                               <?php echo $indentQuantity;?>
                                            </div>
                                        </div>   
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                            <textarea name="remark" required="required"> <?php echo $Remark;?></textarea>
                                                              </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-md-4 col-sm-4 col-xs-12">Consignment Proof</label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                           <img src="<?php echo $proof; ?>" class="img-responsive" style="max-height:70px;" />
                                                              </div>
                                        </div>       
                                        	...
                                        	<div class="form-group">
                                            	...
                                            	<div class="row">
        											<div class="col-md-6 col-sm-6 col-xs-6">
                                            			<input type="radio" id="r1" name="Rbtn" value="A" checked="checked">
                                                    </div>
        											<div class="col-md-6 col-sm-6 col-xs-6">
                                            	...
                                            	<div class="row"><br />
                                                    ...
                                                    <?php
													$ReasonQuery="SELECT RejectedId,RejectedReason FROM tblrejectedreasons WHERE ResStatus='A' and type='R'";
                                                    ...
                                                    <textarea name="ReasonText" class="form-control input-sm" style="resize:none"></textarea>
                                                	</span>	
                                                    </div>
                                            	</div>
    										</div>
							...
							<div class="ln_solid"></div>
                        		<div class="form-group">
                            		<div class="col-md-5 col-sm-5 col-xs-12 col-md-offset-5">
                                		<button type="submit" name="Verify" class="btn btn-primary" onclick="return confirm('Are you Sure Verify Record ?');">Submit</button>
