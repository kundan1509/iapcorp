...
if(isset($_GET['DamageId']))
	...
	$vendordamagedetail="SELECT tblwarehousereplacement.Replacementid,tblwarehouseregistration.warehouseid,tblwarehouseregistration.warehousecode,tblwarehouseregistration.WareHouseName, tblwarehousereplacement.quatity,tblwarehousereplacement.DamageDate,tblwarehousereplacement.Reason,tblwarehouseregistration.warehousename
...
INNER JOIN tbllocation ON tblwarehouseregistration.warehouselocationid=tbllocation.locid WHERE tblwarehousereplacement.RecStatus='A' AND tblwarehousereplacement.Replacementid='$did'";
...
if(isset($_POST['Verify']))
{
	...
	$updatevendorDamage="update tblwarehousereplacement set DamageStatus='Y',Reason='$remark' where replacementid='$damid'";
	$deductvendordamage="INSERT INTO warehousedamagestock(Quatity,DamageDate,Reason,RecStatus,Damagestatus,WareHouseId)VALUES('$qty','$newAppDate','$remark','A','O','$wid')";

$insertinVendorInventory="insert into tblwarehouseinventory(WareHouseId,Quantity,TxnTypeIn_out,TransactionNo,RecStatus)values('$wid','$qty','R','$remark','A')";
	...
	if(mysqli_query($con,$updatevendorDamage))
	{
		...
		echo "<script>window.open('warehouseReplacementList.php','_self')</script>";
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
			<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
				<title>Warehouse Replacement Verify</title>
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" style="color:#FFF; background-color:#889DC6;">
                                    <h2>Warehouse ReplaceMent Verification</h2>
                                ...
                                <input type="hidden" value="<?php echo $reason;?>" name="reason" />
                                <input type="hidden" value="<?php echo $warehouseid;?>" name="wid" />
							...
							<div class="ln_solid"></div>
                        		<div class="form-group">
                            		<div class="col-md-5 col-sm-5 col-xs-12 col-md-offset-5">
                                    	...
                                    	<a href="warehousedamagelist.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                            		</div>
                        		</div>
                    		</div> 
              			</div>
