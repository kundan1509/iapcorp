...
<div class="row">
        ...
        <thead>
            <tr>
                <th style="width:250px;">Security Amount</th>
                <th style="width:250px;">Daily Limit</th>
                <th style="width:250px;">Description</th>
                <th style="width:250px;">Last Update On</th>
        ...
        <tbody>
         ...
         $result = "SELECT Id,SecurityAmmount,DailyLimit,Description,date_format(Lastupdateon,'%d-%m-%y %h:%i:%s') as lastupdate FROM tblstanderdeligibility where RecStatus='A' ORDER BY id DESC LIMIT $start_from,$per_page";
    ...
    <?php
            $query = ("SELECT Id,SecurityAmmount,DailyLimit,Description,date_format(Lastupdateon,'%d-%m-%y %h:%i:%s') as lastupdate FROM tblstanderdeligibility where RecStatus='A' ORDER BY id DESC");
            $res = mysqli_query($con,$query);
            $total_records = mysqli_num_rows($res); 	
            $total_pages = ceil($total_records / $per_page);	
             echo "<center> <a href='EligibilityList.php?page=1' class='btn btn-default fa fa-long-arrow-left'>".'First'."</a> ";
              for ($i=1; $i<=$total_pages; $i++)
	           {
               echo "  <a href='EligibilityList.php?page=".$i."' class='btn btn-default'>".$i."</a> ";
               };
               echo "<a href=EligibilityList.php?page=$total_pages' class='btn btn-default'>".'Last'." <i class='fa fa-long-arrow-right'></i></a></center> ";
?>
...
<footer>
                    <div class="">
                        <p class="col-sm-5">Designed & Developed by Foretek solution LLP  Copyright © 2015-2016 IAP Company Pvt. Ltd<a>
