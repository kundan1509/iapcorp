...
<div class="row">
	  ...
	  $venname=$row['VendorName'];
		 ...
		 echo "
            <tr>
                ...
                <td>
                    <a href='VedorLocationDetails.php?id=$venid' class='btn btn-info' title='Location Details'><i class='fa fa-list'></i></a>
    ...
    <?php
            $query = ("SELECT tblvendorregistration.VendorCode,tblvendorregistration.VendorId,tblvendorregistration.VendorName,tblvendorregistration.ContactNumber,tblvendorregistration.EmailId,tblvendorregistration.Address1 FROM tblvendorregistration WHERE tblvendorregistration.RecStatus='A' ORDER BY tblvendorregistration.vendorid DESC");
            $res = mysqli_query($con,$query);
            $total_records = mysqli_num_rows($res); 	
            $total_pages = ceil($total_records / $per_page);	
             echo "<center> <a href='VedorLocationList.php?page=1' class='btn btn-default fa fa-long-arrow-left'>".'First'."</a> ";
              for ($i=1; $i<=$total_pages; $i++)
	           {
               echo "  <a href='VedorLocationList.php?page=".$i."' class='btn btn-default'>".$i."</a> ";
               };
               echo "<a href='VedorLocationList.php?page=$total_pages' class='btn btn-default'>".'Last'." <i class='fa fa-long-arrow-right'></i></a></center> ";
?>
                        </div>
