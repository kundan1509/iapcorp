...
{
	$distributorStock=$_POST['report'];
	if($distributorStock=='vendor_report')
	{
		echo "<script>window.open('Report.php','_self')</script>";
	}
	else if($distributorStock=='warehouse_report')
	{
		echo "<script>window.open('WarehouseReport.php','_self')</script>";
	}
	else if($distributorStock=="")
	{
            ...
            <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_panel">                            
                                <div class="x_content">
                                	<form action="ReportMis.php" method="post" >                                    	
                                        <div class="x_content">                                    
                                        	...
                                        	<div class="form-group">
                                        		<div class="row">
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
        												...
        												<input type="radio" name="report" checked="checked" value="vendor_report" class="input-md">
                                                        </div>
                                                    </div> 
                                                	<div class="col-md-6 col-sm-6 col-xs-12">
                                                    	<div class="col-md-11 col-sm-11 col-xs-11" style="width:auto;">
        												<label>Warehouse Stock Detail</label>
                                                        </div>
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
        												<input type="radio" name="report" value="warehouse_report" class="input-md">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row"><br /><br />
                                                	<div class="col-md-5 col-sm-5 col-xs-12 col-sm-offset-5">
                                                    	<button  name="printpreview"  type="submit" class="btn btn-md btn-success" style=" width:120px;" onclick="return confirm('Are you  Sure To Print Report?');"  >Print Preview</button> 
                                                    </div>        											
    											</div>                                     	
    										</div>
                                    	</div>
