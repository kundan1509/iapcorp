...
<div class="row">
        ...
        <thead>
            <tr>
                ...
                <th style="width:250px;">Packet Size</th>
        ...
        <tbody>
         ...
         $result = "SELECT Rate,PacketSize,Description FROM tblmasterissue WHERE RecStatus='A' ORDER BY id DESC LIMIT $start_from,$per_page";
	   ...
	   $Desc=$row['Description'];
		 ...
		 echo "
            <tr>
                ...
                <td>
                    <a href='#' class='btn btn-success' title='Edit Damage Records'><i class='fa fa-edit'></i></a>
    ...
    <?php
            $query = ("SELECT Rate,PacketSize,Description FROM tblmasterissue WHERE RecStatus='A'");
            $res = mysqli_query($con,$query);
            $total_records = mysqli_num_rows($res); 	
            $total_pages = ceil($total_records / $per_page);	
             echo "<center> <a href='MasterIssueList.php?page=1' class='btn btn-default fa fa-long-arrow-left'>".'Previous'."</a> ";
              for ($i=1; $i<=$total_pages; $i++)
	           {
               echo "  <a href='MasterIssueList.php?page=".$i."' class='btn btn-default'>".$i."</a> ";
               };
               echo "<a href=MasterIssueList.php?page=$total_pages' class='btn btn-default'>".'Next'." <i class='fa fa-long-arrow-right'></i></a></center> ";
?>
                        </div>
