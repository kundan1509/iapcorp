...
<div class="row">
        ...
        <tbody>
         ...
         $result = "SELECT warehousedamagestock.Damageid,warehousedamagestock.quatity,warehousedamagestock.DamageDate,warehousedamagestock.Reason,tblwarehouseregistration.warehousecode
,tblwarehouseregistration.WareHouseName,tblwarehouseregistration.warehouselocationid,tbllocation.locationName FROM warehousedamagestock INNER JOIN tblwarehouseregistration ON warehousedamagestock.warehouseid=tblwarehouseregistration.warehouseid
INNER JOIN tbllocation ON tblwarehouseregistration.warehouselocationid=tbllocation.locid WHERE warehousedamagestock.RecStatus='A' AND warehousedamagestock.DamageStatus='N' order by warehousedamagestock.Damageid desc LIMIT $start_from,$per_page";
	  $query=mysqli_query($con,$result);
      while ($row = mysqli_fetch_array($query))	  
	  {
		  $damgeid=$row['Damageid'];
	   ...
	   $whname=$row['WareHouseName'];
		 ...
		 echo "
            <tr>
                ...
                <td>
                   <a href='warehouseDamageDetails.php?DamageId=$damgeid' class='btn btn-success' title='verify Damage Records'><i class='fa fa-edit'></i></a>
     ...
     <?php
            $query = ("SELECT warehousedamagestock.Damageid,warehousedamagestock.quatity,warehousedamagestock.DamageDate,warehousedamagestock.Reason,tblwarehouseregistration.warehousecode
,tblwarehouseregistration.warehouselocationid,tbllocation.locationName FROM warehousedamagestock INNER JOIN tblwarehouseregistration ON warehousedamagestock.warehouseid=tblwarehouseregistration.warehouseid
INNER JOIN tbllocation ON tblwarehouseregistration.warehouselocationid=tbllocation.locid WHERE warehousedamagestock.RecStatus='A' AND warehousedamagestock.DamageStatus='N' order by warehousedamagestock.Damageid desc");
            $res = mysqli_query($con,$query);
            $total_records = mysqli_num_rows($res); 	
            $total_pages = ceil($total_records / $per_page);	
             echo "<center><a href='warehousedamagelist.php?page=1' class='btn btn-default fa fa-long-arrow-left'>".'First'."</a> ";
              for ($i=1; $i<=$total_pages; $i++)
	           {
               echo "  <a href='warehousedamagelist.php?page=".$i."' class='btn btn-default'>".$i."</a> ";
               };
               echo "<a href=warehousedamagelist.php?page=$total_pages' class='btn btn-default'>".'Last'." <i class='fa fa-long-arrow-right'></i></a></center> ";
?>
