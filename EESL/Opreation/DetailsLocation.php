        ...
        <div class="main_container">
            ...
            <div class="top_nav">
			  ...
			  <div class="row">
						...
						<div class="x_content">
                      <form class="form-horizontal form-label-left" method="post" action="DetailsLocation.php">     
                           ...
                           <div class="item form-group">
                              ...
                              <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Location Code<span  margin-top:8px;"> *</span></label>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-12">                    
							 ...
							 <div class="item form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">                    
                              <input id="name" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="name" required="required" type="text" value="<?php echo $LocationName; ?>" readonly="readonly">
