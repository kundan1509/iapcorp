...
if(isset($_POST['ok']))
{
	...
	$query="insert into tblstanderdeligibility(SecurityAmmount,DailyLimit,Description,RecStatus,LastUpdateon,Updatebyid)values('$securityAmount','$dailyLimit','$description','A','$date','$UserId')";
...
<div class="row">
					...
					<div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="Eligibility.php">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" onpaste="return false" class="txtNumeric form-control col-md-7 col-xs-12"  name="txtSecurityAmnt" placeholder="Enter Security Amount" maxlength="10" required="*Required Field" onkeypress="return isNumberKey(event)">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" onpaste="return false" class="txtNumeric form-control col-md-7 col-xs-12" data-validate-length-range="6" onkeypress="return isNumberKey(event)" data-validate-words="2" maxlength="10" name="txtDailyLimit" placeholder="Enter Daily Limit" required="*Required Field">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea id="textarea" name="txt_Description" placeholder="Enter Description" class="form-control col-md-7 col-xs-12" style="resize:none;"></textarea>
