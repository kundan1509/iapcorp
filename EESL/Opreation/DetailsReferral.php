...
<?php
	...
	if(isset($_GET['ReferralId']))
	{
	   $ReferralId=$_GET['ReferralId'];
	    ...
	    $result="SELECT ReferralId,ReferralType,EmpId,Name,MobileNo,PanNo,Email,Address FROM tblreferral where RecStatus='A' and ReferralId='$ReferralId'";
	   $Query=mysqli_query($con,$result);		
		while($row=mysqli_fetch_array($Query))
	{
		$ReferralId=$row['ReferralId'];
		$Refftype=$row['ReferralType'];
		$Name=$row['Name'];
		$Email=$row['Email'];       
        $pan=$row['PanNo'];
		$mobile=$row['MobileNo'];
...
if(isset($_SESSION['timeout']))
{
	...
	if(isset($_POST['ok']))
	{
		...
		$updateref="update tblreferral set Name='$Name',MobileNo='$mobile',email='$Email',panno='$pan',address='$address' where ReferralId='$ReferralId'";
		if(mysqli_query($con,$updateref))
		{
			echo "<script>alert('Referral successfully updated')</script>";
			echo "<script>window.open('RefrralList.php','_self')</script>";
		}
		else
		{
			echo "<script>alert('Referral not updated')</script>";
			echo "<script>window.open('RefrralList.php','_self')</script>";
		}
				...
				<div class="row">                
                        <div class="col-md-12 col-sm-12 col-xs-12">                        
                            <div class="x_panel">                      
                               ...
                               <form class="form-horizontal" autocomplete="off" method="post" action="DetailsReferral.php">
                             
                        	<input type="hidden" value="<?php echo $ReferralId; ?>" name="ReferralId" />						
                        
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Referral Type<span style="color:#F00;"> *</span></label>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-12">
                    
                                    <input id="name" class="form-control col-md-7 col-xs-12" onpaste="return false" data-validate-words="2" name="name" required="required" type="text" value="<?php echo $Refftype; ?>" readonly="readonly">
									
                                </div>
                            </div>                         
                            <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Referral Name<span style="color:#F00;">*</span> </label>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-12">
              
                                <input id="name" class="textValidate form-control col-md-7 col-xs-12" onpaste="return false" maxlength="20" name="name" required="required" type="text" value="<?php echo $Name; ?>" onkeypress="return onlyAlphabets(event,this);">
                                </div>
                            </div>
							
							  <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Address<span style="color:#F00;"> *</span></label>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-12">
              
                                <input class="form-control col-md-7 col-xs-12" onpaste="return false" name="address" maxlength="50" required="required" type="text" value="<?php echo $address; ?>">
                                </div>
                            </div>
							
							  <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Email Id<span style="color:#F00;"> *</span></label>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-12">
              
                                <input  class="form-control col-md-7 col-xs-12" onpaste="return false" maxlength="50" data-validate-words="2" name="email" onblur="validateEmail(this);" required="required" type="text" value="<?php echo $Email; ?>">
                                </div>
                            </div>
							
							 <div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Pan Card No</label>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-12">
              
                                <input class="form-control col-md-7 col-xs-12" onpaste="return false" maxlength="10" onblur="ValidatePAN(this);" name="pancard" required="required" type="text" value="<?php echo $pan; ?>">
                                </div>
                            </div>
						<div class="item form-group">
                            	<div class="col-xl-2 col-sm-2 col-xs-12">
                            		<label class="control-label" for="name">Mobile No <span style="color:#F00;"> *</span></label>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-12">
              					<input id="name" class="txtNumeric form-control col-md-7 col-xs-120" onpaste="return false" name="mobile" maxlength="10" required="required" type="text" value="<?php echo $mobile;?>" onkeypress="return isNumberKey(event);" />
                                </div>
                            </div>
                            	...
                            	<div class="form-group">
                                	<div class="col-md-6 col-md-offset-3 col-xs-12">
                                     <button name="ok" type="submit" class="btn btn-primary">Update</button>
                                        ...
                                        <a  href="RefrralList.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                                	</div>
                            </div>
                        </form>
