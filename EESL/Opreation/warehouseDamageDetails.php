...
if(isset($_GET['DamageId']))
	...
	$vendordamagedetail="SELECT warehousedamagestock.Damageid, warehousedamagestock.warehouseid,warehousedamagestock.quatity,warehousedamagestock.DamageDate,warehousedamagestock.Reason,tblwarehouseregistration.warehousename
,tblwarehouseregistration.warehouselocationid,tblwarehouseregistration.WareHouseCode,tbllocation.locationName FROM warehousedamagestock INNER JOIN tblwarehouseregistration ON warehousedamagestock.warehouseid=tblwarehouseregistration.warehouseid
INNER JOIN tbllocation ON tblwarehouseregistration.warehouselocationid=tbllocation.locid WHERE warehousedamagestock.Damageid='$did'";
...
if(isset($_POST['Verify']))
{
	$damid= $damageid;
	$remark=$_POST['remark'];
	$updatevendorDamage="update warehousedamagestock set DamageStatus='Y',VerifyRemarks='$remark' where DamageId='$damid'";
	if(mysqli_query($con,$updatevendorDamage))
	{
		$insertinwareInventory="insert into tblwarehouseinventory(warehouseid,Quantity,TxnTypeIn_out,TransactionNo,RecStatus)values('$warehouseid','$quantity','OUT','$reason','A')";
		mysqli_query($con,$insertinwareInventory);
		echo "<script>alert('Damge Successfully Verify')</script>";
		echo "<script>window.open('warehousedamagelist.php','_self')</script>";
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" style="color:#FFF; background-color:#889DC6;">
                                    <h2>Warehouse Damge Verification</h2>
