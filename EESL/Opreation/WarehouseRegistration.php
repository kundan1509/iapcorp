...
<div class="row">
						...
						<div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" autocomplete="off" method="post" action="ResultWarehouseRegistration.php" onsubmit="return chechform();">
										
                                       <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Select State<span style=" color:#F00">*</span></label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select name="StateList" id="country-list" class="form-control" onChange="getState(this.value);">
                                       ...
                                       <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select name="LocationList" required="required" class="form-control" id="LocList-list">
                                       ...
                                       <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" onpaste="return false" class="textValidate form-control col-md-7 col-xs-12"  name="txtmanagername" placeholder="Enter Name" required type="text" maxlength="50" onkeypress="return onlyAlphabets(event,this);">
                                            </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" onpaste="return false" class="textValidate form-control col-md-7 col-xs-12"  name="txtwarehousename" placeholder="Enter Name" required type="text" maxlength="50" onkeypress="return onlyAlphabets(event,this);">
                                            </div>
                                       ...
                                       <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="email" id="email" onpaste="return false" name="txtEmail" onBlur="validateEmail(this);" placeholder="Enter Manager E-mail" required class="form-control col-md-7 col-xs-12" maxlength="50">
                                       ...
                                       <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="contactnumber" onpaste="return false" name="txtContactNumber" placeholder="Enter Manager Contact Number" data-validate-linked="email" required class="txtNumeric form-control col-md-7 col-xs-12" maxlength="10" onkeypress="return isNumberKey(event);" pattern=".{5,10}">
                                            </div>
                                       ...
                                       <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="altercontactnumber" onpaste="return false" name="txtalterContactNumber" placeholder="Enter Manager Alternate Contact Number" data-validate-linked="email" class="txtNumeric form-control col-md-7 col-xs-12" maxlength="10" onkeypress="return isNumberKey(event);">
                                            </div>
                                        </div><br /> 
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea id="textarea" required name="txtAddress" onpaste="return false" class="form-control col-md-7 col-xs-12" placeholder="Enter Mailing Address" style="resize:none;"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea id="textarea" name="txtDescription" placeholder="Enter Description" class="form-control col-md-7 col-xs-12" style="resize:none;"></textarea>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-5">
                                            <input type="submit" name="SaveWareHouse" class="btn btn-primary" value="Save Record" />
