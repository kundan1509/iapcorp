...
<div class="row">
						...
						<div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="LocationResult.php">									
										<div class="row">
                                            	<div class="col-lg-2 col-sm-2 col-xs-12">
                                                	<label class="control-label">Select State<span style="color:red; margin-top:8px;"> *</span></label>
                                                </div>
                                                <div class="col-lg-4 col-sm-4 col-xs-12">                                                	
													<select name="StateList" id="country-list" class="form-control input-sm" onChange="getState(this.value);">
                                        ...
                                        <div class="row">
                                            	<div class="col-lg-2 col-sm-2 col-xs-12">
                                                	<label class="control-label">Select District<span style="color:red; margin-top:8px;"> *</span></label>
                                                </div>
                                                <div class="col-lg-4 col-sm-4 col-xs-12">
                                                	<select name="DistricList" required="required" class="form-control input-sm" id="state-list">
                                        ...
                                        <div class="row">
                                            	<div class="col-lg-2 col-sm-2 col-xs-12">
                                                	<label class="control-label">Location Name<span style="color:red; margin-top:8px;"> *</span></label>
                                                </div>
                                                <div class="col-lg-4 col-sm-4 col-xs-12">
                                                	<input type="text" name="LocationName" required="required" onpaste="return false " maxlength="20" class="form-control input-sm" id="LocName"  placeholder="Location Name" />
                                                 </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-12">
                                                	<textarea id="textarea" name="Description" placeholder="Enter Description" class="form-control input-sm" style="resize:none;" ></textarea>
                                                </div>
                                            </div><br />
                                            <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">                                               
                                                <button id="send" type="submit" name="SaveLocation" class="btn btn-primary">Save Record</button>
                                            </div>
                                        </div>
