...
include("../connection/connection.php");
  session_start();
	...
	if(isset($_POST['ResetPassword']))
	{
		...
		$fetchData="select password from tbluser where Id='$UserId' and usertypes='RO'";
					       ...
					       <li><a><i class="fa fa-cog"></i> Configuration<span class="fa fa-chevron-down"></span></a>
                                ...
                                <li><a><i class="fa fa-th-list"></i>&nbsp;Display<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li><a href="PollAccountLIst.php">PollAccount List</a></li>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 col-sm-4 col-xs-12">Enter Old Password<span style=" color:#F00">*</span></label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                            	<input type="password" name="Password" maxlength="15" required="required" class="form-control input-sm" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 col-sm-4 col-xs-12">Enter New Password<span style=" color:#F00">*</span></label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                               <input type="password" name="RePassword" maxlength="15" onblur="return fd4();" id="newpass" required="required" class="form-control input-sm" />
                                               <span style=" color:#60C">password should be 8-15 character</span>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-md-4 col-sm-4 col-xs-12">Re-Enter New Password<span style=" color:#F00">*</span></label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                               <input id="newpassword"  type="password" maxlength="15" onblur="return fd3();" name="RePassword1" required="required" class="form-control input-sm" />
                                               <span style=" color:#60C">password should be 8-15 character</span>
                            		...
                            		<div class="col-md-5 col-sm-5 col-xs-12 col-md-offset-5">
                                		<button type="submit" name="ResetPassword"  class="btn btn-primary">Save Changes</button>
