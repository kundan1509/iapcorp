...
<?php
	if(isset($_GET['AccountId']))
	{
		...
		$RemoveQuery="UPDATE tblpollaccount SET RecStatus='D' WHERE AccountId='$AccountId' AND RecStatus='A' ";
...
<div class="row">
        ...
        <thead>
            <tr>
                <th style="width:250px;">Bank Name</th>
                <th style="width:250px;">PoolAccount No</th> 
                 <th style="width:250px;">PoolAccount IFSC</th>         		
	  ...
	  $result ="SELECT AccountId,BankName,AccountNo,IFSCCode FROM tblpollaccount where RecStatus='A' ORDER BY AccountId DESC LIMIT $start_from,$per_page";
		 ...
		 echo "
            <tr>
                ...
                <td>
				     ...
				     <a href='DetailsPoolAccount.php?AccountId=$AccountId' class='btn btn-success' title='edit  PoolAccount  Records'><i class='fa fa-edit'></i></a>
                    <a href='PoolAcountLIst.php?AccountId=$AccountId' class='btn btn-danger' data-toggle='tooltip' title='Remove PoolAccount' onclick=\"return confirm('Are You sure Remove User Details ?');\"><i class='fa fa-trash'></i></a>					 
    ...
    <?php
            $query = ("SELECT AccountId,BankName,AccountNo,IFSCCode FROM tblpollaccount where RecStatus='A' ORDER BY AccountId DESC");
            $res = mysqli_query($con,$query);
            $total_records = mysqli_num_rows($res); 	
            $total_pages = ceil($total_records / $per_page);	
             echo "<center><a href='PoolAcountLIst.php?page=1' class='btn btn-default fa fa-long-arrow-left'>".'First'."</a> ";
              for ($i=1; $i<=$total_pages; $i++)
	           {
               echo "  <a href='PoolAcountLIst.php?page=".$i."' class='btn btn-default'>".$i."</a> ";
               };
               echo "<a href=PoolAcountLIst.php?page=$total_pages' class='btn btn-default'>".'Last'." <i class='fa fa-long-arrow-right'></i></a></center> ";
?>
