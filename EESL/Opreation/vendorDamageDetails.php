...
if(isset($_GET['DamageId']))
	...
	$vendordamagedetail="SELECT vendordamagestock.DamageId,vendordamagestock.quatity, DATE_FORMAT(vendordamagestock.DamageDate,'%d-%m-%y')AS DamageDate,vendordamagestock.Reason,vendordamagestock.locationid,tblvendorregistration.vendorid,tblvendorregistration.vendorname,tbllocation.locationName,
tblvendorlocation.locationid FROM vendordamagestock INNER JOIN tblvendorlocation ON vendordamagestock.locationid=tblvendorlocation.locationid
INNER JOIN tblvendorregistration ON tblvendorregistration.vendorid=vendordamagestock.vendorid INNER JOIN tbllocation ON tbllocation.locid=tblvendorlocation.locationid WHERE vendordamagestock.Damageid='$did'";
...
if(isset($_POST['Verify']))
{
	$damid= $damageid;
	$remark=$_POST["remark"];
	$updatevendorDamage="update vendordamagestock set DamageStatus='Y',VerifyRemarks='$remark' where DamageId='$damid'";
	if(mysqli_query($con,$updatevendorDamage))
	{
		$insertinVendorInventory="insert into tblvendorinventory(vendorid,Quantity,TxnTypeIn_out,TransactionNo,LocationId,RecStatus)values('$vid','$quantity','OUT','$reason','$lid','A')";
		mysqli_query($con,$insertinVendorInventory);
		echo "<script>alert('Damge Successfully Verify')</script>";
		echo "<script>window.open('vendordamagelist.php','_self')</script>";
		
	}
	else
	{
		echo "<script>alert('Damge Not Verify')</script>";
		echo "<script>window.open('vendordamagelist.php','_self')</script>";
	}
}
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
			<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
				<title> Distributor  Damage  Details</title>
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" style="color:#FFF; background-color:#889DC6;">
                                    <h2>Distributor Damge Verification</h2>
                                ...
                                <div class="x_content">                                    
                                    <div class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">                                        	
                                            <label class="col-md-4 col-sm-4 col-xs-12">Distributor Quantity:</label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <?php echo $quantity;?>
                                            </div>
                                        </div>
							...
							<div class="ln_solid"></div>
                        		<div class="form-group">
                            		<div class="col-md-5 col-sm-5 col-xs-12 col-md-offset-5">
                                    	...
                                    	<a href="vendordamagelist.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back</a>
                            		</div>
                        		</div>
                    		</div> 
              			</div>
