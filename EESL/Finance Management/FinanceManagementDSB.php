                        ...
                        <div class="menu_section">                            
                            <ul class="nav side-menu">
								...
								<?php 
									if($UserType=='SA')
									{
										echo "<li><a href='../Administrator/AdministratorDSB.php'><i class='fa fa-home'></i> Administrator </a></li>";
										echo "<li><a href='../Opreation/OperationDSB.php'><i class='fa fa-home'></i> Operation </a></li>";
