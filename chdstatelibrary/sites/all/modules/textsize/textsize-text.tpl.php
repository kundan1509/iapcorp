...
<?php  if ($textsize_increase): ?>
  <li class="ts_increase_<?php print check_plain($link_type); ?>"><?php print l('<span title="Increase Text Size" class="'. $display_links .'">'. t('A') .'</span>', 'textsize/increase', array('attributes' => array('title' =>  t('Increase Text Size') , 'class' => 'ts_icon ts_increase_'. $link_type .' textsize_increase text_'. $display_links), 'query' => $dest, 'html' => TRUE)); ?></li>
<?php endif; ?>
<?php  if ($textsize_decrease): ?>
  <li class="ts_decrease_<?php print check_plain($link_type); ?>"><?php print l('<span title="Decrease Text Size" class="'. $display_links .'">'. t('A') .'</span>', 'textsize/decrease', array('attributes' => array('title' =>  t('Decrease Text Size') , 'class' => 'ts_icon ts_decrease_'. $link_type .' textsize_decrease text_'. $display_links), 'query' => $dest, 'html' => TRUE)); ?></li>
<?php endif; ?>
<?php  if ($textsize_normal): ?>
  <li class="ts_normal_<?php print check_plain($link_type); ?>"><?php print l('<span title="Normal Text Size" class="'. $display_links .'">'. t('A') .'</span>', 'textsize/normal', array('attributes' => array('title' => t('Normal Text Size'), 'class' => 'ts_icon ts_normal_'. $link_type .' textsize_normal text_'. $display_links), 'query' => $dest, 'html' => TRUE)); ?></li>
<?php endif; ?>
</ul>
